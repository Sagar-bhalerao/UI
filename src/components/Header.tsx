...
const Header = () => {
  return (
    <>
      {/* <!-- ========== HEADER ========== --> */}
      <header className="sticky top-0 left-0 right-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 lg:ps-[260px] dark:bg-neutral-800 dark:border-neutral-700">
